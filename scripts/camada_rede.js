/**
 * CAMADA DE REDE — Roteamento IP com Dijkstra
 *
 * Posição no modelo OSI: Camada 3
 * Recebe os dados do Transporte (Camada 4) e os encaminha à Enlace (Camada 2).
 *
